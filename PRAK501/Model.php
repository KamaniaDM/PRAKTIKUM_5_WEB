...
class Model {                   
    ...
    {         
        ...
        ('$nama',  '$nomor',  '$alamat',  now(), '$tgl_terakhir_bayar')";         
        $result = mysqli_query($GLOBALS['koneksi'], $sql);         
        return $result;     
    }
    public function editMember($id, $nama, $nomor, $alamat, $tgl_terakhir_bayar)     
    {         
        $sql  =  "UPDATE  member  SET  nama_member  =  '$nama', nomor_member  =  '$nomor',  alamat  =  '$alamat', tgl_terakhir_bayar  =  '$tgl_terakhir_bayar'  
        WHERE  id_member = '$id'";         
        $result = mysqli_query($GLOBALS['koneksi'], $sql);         
        return $result;     
    }      
    ...
    {         
        $sql  =  "UPDATE  buku  SET  judul_buku  =  '$judul', penulis  =  '$penulis',  penerbit  =  '$penerbit',  tahun_terbit = '$tahunTerbit' 
        WHERE id_buku = '$id'";         
        $result = mysqli_query($GLOBALS['koneksi'], $sql);         
        return $result;     
    }      
    ...
    {         
        $sql  =  "UPDATE  peminjaman  SET  tgl_pinjam  = '$tglPinjam',  tgl_kembali  =  '$tglKembali'  
